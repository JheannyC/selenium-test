...
public class TesteRegrasCadastro {
    ...
    public void deveValidarRegras(){
        ...
        if(comidas.contains("Carne")) page.favoriteFoodMeat();
        if(comidas.contains("Pizza")) page.favoriteFoodPizza();
        if(comidas.contains("Vegetariano")) page.favoriteFoodVegetarian();
        page.setSport(esportes);
        page.register();
        System.out.println(msg);
        Assert.assertEquals(msg, dsl.getAlertTextAccept());
    }
}
